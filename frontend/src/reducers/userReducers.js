...
export const checkUserSignOutReducer = (state={}, action) =>{
    switch(action.type) {
        case CHECK_USER_SIGNOUT:
            return {signout:true};
        default:
            return state;
