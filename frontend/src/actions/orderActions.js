...
export const summaryOrder = () => async (dispatch, getState)=> {
    ...
    try {
        ...
        dispatch({type:ORDER_SUMMARY_CREATE_FAIL, payload:error.response && error.response.data.message ? error.response.data.message : error.message});
    }
}