...
export default function SupportScreen() {
    ...
    const [socket, seetSocket] = useState(null);
    ...
    }, [socket, users, messages, userInfo]);
    ...
    const submitHandler = (e) => {
        ...
        if(!messageBody.trim()) {
            ...
            allMessages = [
                ...allMessages, {body: messageBody, name: userInfo.name},
            ];
    ...
    return (
        <div className="row top full-container">
            ...
            <div className="col-3 support-messages">
                {!selectedUser._id ? (
                    <MessageBox>Select a unser to start chat</MessageBox>
                ) :
                (
                    <div>
                        <div className="row">
